 ...
 */
public class CitationTitleComparator implements Comparator<Citation> {

	@Override
	public int compare(Citation o1, Citation o2) {
		CitationComparator.isComparable(o1, o2, EntryName.TITLE);
		return o1.get(EntryName.TITLE).compareTo(o2.get(EntryName.TITLE));
	}
